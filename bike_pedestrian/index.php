...
<body class="font-sans text-[#000000] bg-white">
    ...
    <div id="contact" class="relative bg-cover bg-center bg-no-repeat md:min-h-[85vh]" style="background-image: url('../images/bike_pedestrian.jpg');">
